/**
 * VapourZone - Ephemeral content display
 *
 * Shows:
 * - Others' vapor (real-time streaming from proximate entities)
 * - Soft-LLM responses to queries
 *
 * Input is handled by ConstructionButton, not here.
 * This is display-only UI — does not encode categories.
 */
...
export function VapourZone({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-[100px] relative overflow-hidden bg-card/30">
