 ...
 *
 * Shows face selector, presence, frame selector, settings.
 * Ported from construct-button branch.
 */
    ...
    <header className="flex items-center justify-between px-3 py-2 border-b border-border/50 bg-background">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {showFaceMenu && (
            <div className="absolute top-full left-0 mt-1 py-1 bg-popover border border-border rounded-md shadow-lg z-20 min-w-[120px]">
      ...
      <div className="flex items-center gap-2">
        <span className="text-xs font-mono text-muted-foreground bg-muted px-2 py-0.5 rounded">{stateCode}</span>
        <button
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {showFrameMenu && (
            <div className="absolute top-full right-0 mt-1 py-1 bg-popover border border-border rounded-md shadow-lg z-20 min-w-[180px]">
              {frames.map((f) => (
                <button
                  key={f.id || 'none'}
                  onClick={() => {
